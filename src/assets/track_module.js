export default function generate(THREE){
  ...
  const roadColors=[0x10171f,0x111820,0x121921,0x131a22],gun=mk(0x27313b,.38,.72),pale=mk(0xdce5e7,.46,.05,'stone');
  ...
  [-4.5,-1.5,1.5,4.5].forEach((x,i)=>{add(2.9,.48,47.8,x,.62,0,mk(roadColors[i],.72+i*.006,.12,'ground'));add(.055,.035,44,x+1.42,.89,0,cyan);});
