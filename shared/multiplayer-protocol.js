export const ClientEvent = Object.freeze({
  ...
  PLAYER_LOADED: 'PLAYER_LOADED', CLOCK_PING: 'CLOCK_PING',
  RACE_SNAPSHOT: 'RACE_SNAPSHOT', RACE_RESET: 'RACE_RESET',
  REMATCH_REQUEST: 'REMATCH_REQUEST', RETURN_TO_LOBBY: 'RETURN_TO_LOBBY',
});
...
export const ServerEvent = Object.freeze({
  ...
  LOADING_STARTED: 'LOADING_STARTED', CLOCK_PONG: 'CLOCK_PONG',
  RACE_START_SCHEDULED: 'RACE_START_SCHEDULED', RACE_STARTED: 'RACE_STARTED',
  RACE_SNAPSHOT_BATCH: 'RACE_SNAPSHOT_BATCH', CHECKPOINT_CONFIRMED: 'CHECKPOINT_CONFIRMED',
  LAP_CONFIRMED: 'LAP_CONFIRMED', PLAYER_FINISHED: 'PLAYER_FINISHED',
  PLAYER_DNF: 'PLAYER_DNF', RACE_RESULTS: 'RACE_RESULTS',
  RESET_CONFIRMED: 'RESET_CONFIRMED', REMATCH_STARTED: 'REMATCH_STARTED',
  RETURNED_TO_LOBBY: 'RETURNED_TO_LOBBY', ERROR: 'ERROR',
});
